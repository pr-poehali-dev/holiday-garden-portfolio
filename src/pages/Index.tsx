...
const Index = () => {
  ...
  const process = [
    ...
    { step: "02", title: "Концепции", description: "Предлагаем различные концепции оформления" },
    { step: "03", title: "Согласование", description: "Утверждаем все детали и материалы" },
    { step: "04", title: "Быстрый монтаж", description: "Оперативная установка и настройка декора" }
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto font-light">Предоставляем уникальные композиции для максимального погружения в новогоднюю атмосферу.</p>
      ...
      <footer className="py-8 px-4 border-t border-primary/20">
        <div className="container mx-auto text-center text-muted-foreground">
          <p>© 2025 Новогодний Декор. Все права защищены.</p>
        </div>
      </footer>
    </div>
  );
